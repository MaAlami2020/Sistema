...
public class Operador extends MenuInicio{
    ...
    public void añadir_atributos_personaje(){
      try{
          ...
          switch(opcion){
             case 1:{
                List<Arma> armas = user.actualizarListaArmas();
                user.setArmasPersonaje(armas);
                break;
             }case 2:{
                List<Armadura> armaduras = user.actualizarListaArmaduras();
                user.setArmadurasPersonaje(armaduras);
                break;
             }case 3:{
