...
public class Usuario extends MenuInicio{
    ...
    public void anadirNuevoUsuario(String name,String apodo,String contrasenia,StringBuilder reg,Personaje tipoPersonaje) throws IOException{
    ...
    public List<Armadura> actualizarListaArmaduras(){
        String anadirNueva;
        List<Armadura> armadurasPer =  new ArrayList<>();
        do{
            Armadura armadura = anadirArmadura();
            armadurasPer.add(armadura);
    ...
    public void setArmadurasPersonaje(List<Armadura> armadurasPer){
        tipoPersonaje.setListaArmaduras(armadurasPer);
    }
    ...
    public List<Arma> actualizarListaArmas(){
        String anadirNueva;
        List<Arma> armasPer = new ArrayList<>();
        do{
            Arma arma = anadirArma();
            armasPer.add(arma);
    ...
    public void setArmasPersonaje(List<Arma> armasPer){
        tipoPersonaje.setListaArmas(armasPer);
    }
    ...
    public void atributosComunesPersonaje(){
        ...
        List<Armadura> armadurasPer = actualizarListaArmaduras();
        setArmadurasPersonaje(armadurasPer);
        List<Arma> armasPer = actualizarListaArmas();
        setArmasPersonaje(armasPer);
    ...
    public void registrar_vampiro(){
        ...
        tipoPersonaje = fabrica.crearPersonaje();
